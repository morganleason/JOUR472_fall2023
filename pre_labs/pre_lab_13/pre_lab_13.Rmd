...
**Task** Run the following code and describe the dataframe it outputs. **Answer: This shows the state data that incldues which states voted for which presidential candidate, the total dollars spent per pupil, as well as the population change and gdp growth.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer: The scatterplot shows the relationship between population change and GDP growth. There appears to be very weak correlation between the two variables.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer: This scatterplot is the total dollars spent per pupil and the GDP growth. The relationship appears even weaker.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer: This takes the state data and removes irrelevant data like the state names and how they vote, and includes the correlations between the variables. For example, there is a slightly negative correlation between GDP growth and expenditures per student.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: This shows whether the measurements are statistically significant, which is revealed that there is statistical signficance in the money spent per pupil and the population change. Therefore, there is no correlation here.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer: No, there is still very weak negative correlation. The p-value of .67 is not statistically significant.**
...
**Task** Run the following code. Describe the table. What do you see? **Answer: These are the average GDP growth in states won by Biden and Trump. The state that grew the most was Biden. The state that spent the most on students was Democratic states.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: The p-value is a little bit above .05, which means the relationship between population change and the vote was not statistically significant. There is a correlation here.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer: The p-value is very small, which means the relationship between the spending per pupil and the vote is statistically significant. There is no correlation here.**
