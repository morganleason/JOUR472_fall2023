...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer: Takes the list of words and takes out what is unique about this list, or the only time that the word is being used in that text to avoid repetition. Since Dog and dog had different capitalization, it considered it to be two words.**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer: This one created a chart of all of the unique words by order in which they appear, with over 6,000 entries.**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer: The resulting graphic shows all of the unique words found in Cardin releases. The most common word is "the".**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer: Anti-join uses the unique words of the specific piece and analyzes those stop words to avoid including them, along with the custom stop words we already accounted for. These results are much more interesting than before because there are no stop words. The top word is "health", then "support" and finally, "project".**
...
**Task** Run the following code and describe the results. **Answer: The top few words of the year are "act", "national", "health", "community", "women", "legislation", "american", "rights", "congress" and "fire".**
...
**Task** Run the following code and describe the results. **Answer: broke apart the text into combinations of words rather than individual words such as "covid-19" and "human rights".**
...
**Task** Run the following code and describe the results. **Answer: This took away tsome he groupings of words that did not really make much sense but there are still some remaining like "location baltimore".**
...
**Task** Run the following code and describe the results. **Answer: the results of this code are two words that comprehensively go together without combinations that do not work.**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer: the sentiments seem accurate but it depends on the context in which the words are used.**
