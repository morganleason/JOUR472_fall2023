...
**Task** Put the following code -- which stores the numeral 2 as a variable called number -- in the console and hit enter.num
...
**Answer: 395 observations, 8 variables**
...
![](images/Screenshot%202023-09-12%20at%202.07.34%20PM.png)
...
**Answer: The first line is selecting the umd_courses data set. The second line is taking all of the terms and grouping their results. The third and fourth line is adding up all the records in each term of the data set.**
...
**Answer: The difference is that now the values of the count classes column are arranged in descending order.**
...
**Answer: Now, the rows are ordered primarily by the term column, and within each term, ordered by the department column.**
...
**Answer: Now we are finding the total number of seats in the classes and arranging them in descending order. Similar to above where the column is arranged in descending order, except now we are summing up the seats.**

The numbers seem to appear in descending order.
...
**Answer: This time we are looking at descriptive statistics explaining the data set. This includes the mean, median, maximum, and minimum value in the data set.**
...
1.  What classes get filled up the quickest?

2.  What is the demographic of the students in each of the classes?

3.  What has the seat-count been in previous years? Has it increased/decreased/stayed the same?
