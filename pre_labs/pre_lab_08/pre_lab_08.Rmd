...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer: 4 rows, 3,822 columns.**
...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer: the steps are creating a new column called month that puts the dates into the month category, and then summarizes to only see the total number of calls, which leaves only 2 columns.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: A grey box with nothing inside.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: This code created bars with the x-axis being the months and the y-axis being the total call count.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: We have reordered the X-axis to show the month and total calls.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: This time, we did a coordinate flip, which turned the graph sideways by making our column chart a horizontal bar chart.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: The theme minimal function changes the fonts and lightness of the graph. It makes the graph more visually appealing.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer: Adding this theme created color to the chart to bring out the bars.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer: The labels function simplifies the titles and axis, making them easier to understand.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: This code takes the data and keeps the date column but still simplifies to total calls.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: I see that the x-axis is labeled data and the y is labeled total_calls. Then the created line is arranged sporadically with an obvious minimum and maximum value.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: In this block, we now have weekly "breaks" in the data set that helps organize the data. However, now the data looks very clumped together.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer: Changing the angle of the text makes it more readable and less clumped together.**
