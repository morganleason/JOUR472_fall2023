...
**Task** Export the CSV file to your pre_lab_05 folder and read it into R by running the following codeblock. What problems do you see with the data? **Answer: There are no column names.**
...
**Task** Load the data without headers by running the codeblock below. What problems remain? **Answer: R made up the column names because we told R that there were no column names.**
...
**Task** Run the codeblock below. What else do we need to do? **Answer: Now we need to change the headers to actual names using the rename function.**
