...
**Answer**: <https://datawrapper.dwcdn.net/oZ0e2/2/>
...
There is a much more narrowed view of the counties when we hide the unused data.
...
The map becomes much more comprehensive because when you hover, you see a number with only one decimal and the county that you are viewing, rather than the flip code.
...
<https://datawrapper.dwcdn.net/xp4FD/1/>
