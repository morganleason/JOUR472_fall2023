...
```{r echo=FALSE}
census_api_key("3686607b2468a54c52a184022236907a56ceb836"), install=TRUE)
```
...
**Answer: Howard County has the highest median income.** \$129,000 estimate. The margin of error is \$**2,980.**
...
**Answer: The graph should be named Census of Household Income Distribution in Maryland's Counties.**
...
Is the difference between Calvert and Montgomery significant? **Answer: No because there is overlap in the margin of error bar.**

Is the difference between Howard and everyone else significant? **Answer: Yes because everyone else is outside of the error bar.**
...
**Answer: Baltimore City had the largest growth of 37%.**
...
**Answer: We could ask whether income has to do with graduation rates. There are confounding variables like socioeconomic status that change the demographics of the people included in the census or make the results difficult to interpret.**
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer: Students with higher household incomes are more likely to immediately enroll in college. There are 50 zip codes with an average income of \$1,114,483 in which more than 60% of high school students enroll immediately in college. On the other hand, there are 76 zip codes in which they have an average income of \$69,252.24 and have high school students that do not enroll in college immediately.**
...
**Task** What is another question you could ask of this data? **Answer: What is the average relationship between household income and party affiliation in all of the counties across Maryland?**
