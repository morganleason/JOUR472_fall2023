...
media_expenses_clean |> group_by(payee_name) |> summarize(total = sum(amount)) |> arrange(desc(total))
...
**A2. Jain Ashwani, Franchot Anderson-Walker, Jon Baron, and John King are all running for Maryland Governor. Billy Boniface is running for Republican candidate for Harford County Executive and Eve Shuman ran for a Prince George's County Council seat . WFP PAC and CASA in Action PAC are left-wing political parties. The advertisements are often infographics and videos. Some of the ads include blocked content.**
...
**A3. Wes Moore is missing from the list. Those campaigns did run Facebook ads. Moore Miller for Maryland Slate is the biggest recipient of media expenses by the Democratic primary winner for governor. Then, it is Blair David for Montgomery and Lierman Brooke for Maryland.**
...
**A4. This list is longer and has a different list of committees with the highest spending. The list of the top 5 committees who spent the all their online advertising dollars on Facebook include: Jain Ashwani Friends of, Franchot Anderson-Walker for Maryland Slate/Franchot Peter Friends Of, Boniface Billy Friends Of and Baron Jon (Jonathan) for Maryland.**
...
**A5: We know that many of the candidates for governor are contributing to the largest expenses in Maryland. Also, many of the Democratic candidates are receiving funding from large PACs with a progressive lean. We do not know who exactly is made up of these PACs and we do not know why facebook has contributed so much to online advertisement expenses. The best story could be that Facebook wants to invest in the Democratic election and help get one of these candidates elected.**
